...
> **Direção Nacional da Polícia Judiciária** · *webpage* · 16/09/2025 · [link](https://www.policiajudiciaria.pt/operacao-pivot-mais-de-60-detencoes-por-burla-qualificada-e-branqueamento/)
> Zotero key: `5PLKQVTB` · Bibkey: `@OperacaoPivotMais`

## Tags
- **type:** `news`, `website`
- **role:** `evidence`, `motivation`
- **area:** `deepfakes`, `digital-identity`, `security`
- **thesis:** `motivation`
- **quality:** `useful`
- **priority:** `low`, `medium`
...
**Cap.1 (Introduction) — Motivação empírica: fraude digital, simulação de identidade e erosão da confiança**: «A evolução recente da criminalidade confirma, além disso, uma tendência de profissionalização, escala e sofisticação. Em novembro de 2024, a Polícia Judiciária anunciou o desmantelamento de um grupo organizado transnacional associado a esquemas de \textit{“CEO Fraud”}, envolvendo crimes de falsificação documental, burla informática e branqueamento. Em setemb…»
