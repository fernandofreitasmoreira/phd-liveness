---
bibkey: republicaDecretoLeiNo12
zotero-key: CU66TSFX
...
> **Governo de Portugal** · *webpage* · 2021 · [link](https://diariodarepublica.pt/dr/detalhe/decreto-lei/12-2021-156848060)
> Zotero key: `CU66TSFX` · Bibkey: `@republicaDecretoLeiNo12`

## Tags
- **type:** `regulation`, `website`
- **role:** `motivation`, `regulation`
...
Assegura a execução na ordem jurídica interna do Regulamento (UE) 910/2014, relativo à identificação eletrónica e aos serviços de confiança para as transações eletrónicas no mercado interno [DERIVADO DO ABSTRACT — refinar.]
